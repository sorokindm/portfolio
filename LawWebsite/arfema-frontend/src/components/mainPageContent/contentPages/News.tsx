...
function News() {
    ...
    useEffect(() => {
      ...
      fetch(import.meta.env.VITE_GET_ALL_NEWS + "?page=" + numPageParam).then((x) =>
  ...
  return (
    <>
      <div className="content-wrapper">
        ...
        <PageComponent page={getNumPageParam(Number(pageParam))} maxPages={content?.maxPages ?? 0} route={"/novosti"}/>
      </div>
    </>
  );
}
